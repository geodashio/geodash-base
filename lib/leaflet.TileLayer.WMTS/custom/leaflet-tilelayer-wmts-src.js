L.TileLayer.WMTS = L.TileLayer.extend({
    ...
    initialize: function (url, options) { // (String, Object)
        ...
        for (var i in options) {
            ...
            var not_wmts = ["matrixIds", "renderOrder", "attribution", "minZoom", "maxZoom", "maxNativeZoom"];
            if (!this.options.hasOwnProperty(i) && not_wmts.indexOf(i) == -1) {
    ...
    getTileUrl: function (tilePoint, zoom) { // (Point, Number) -> String
        ...
        tileMatrix = this.options.tilematrixSet+":"+(zoom+1);
