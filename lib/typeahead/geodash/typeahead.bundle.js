    ...
    var SearchIndex = window.SearchIndex = function() {
        ...
        _.mixin(SearchIndex.prototype, {
            ...
            getByPropertyName: function(propertyName, propertyValues) {
                var that = this;
                var datumsAsArray = _.map(that.datums, function(obj) {
                    return obj;
                });
                return _.filter(datumsAsArray, function(obj) {
                    var objectValue = obj[propertyName];
                    return _.filter(propertyValues, function(x) {
        ...
        _.mixin(Prefetch.prototype, {
            ...
            fromNetwork: function(cb) {
                ...
                function onResponse(resp) {
                    ...
                    if (that.eventBus != undefined) {
                        that.eventBus.trigger("change", that.input.getQuery());
                    }
                }
            },
        ...
        _.mixin(Bloodhound.prototype, {
            ...
            search: function search(query, sync, async, filters) {
                ...
                local = query == "" ? $.map(this.sorter(this.index.datums), function(d, i) {
                    return d;
                }) : this.sorter(this.index.search(queryFree));
